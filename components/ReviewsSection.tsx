...
const reviews = [
  {
    ...
    avatar: "https://images.unsplash.com/photo-1747913516863-3faf530ca992?w=100&h=100&fit=crop",
  },
  {
    name: "Елена Смирнова",
    ...
    avatar: "https://images.unsplash.com/photo-1662850886700-4ec19bd30d11?w=100&h=100&fit=crop",
  },
  {
    name: "Дмитрий Иванов",
    ...
    avatar: "https://images.unsplash.com/photo-1689357639534-f1e660efa070?w=100&h=100&fit=crop",
  },
  {
    ...
    avatar: "https://images.unsplash.com/photo-1665065950598-3993c1331626?w=100&h=100&fit=crop",
  },
  {
    name: "Сергей Новиков",
    ...
    avatar: "https://images.unsplash.com/photo-1643155571142-87a06fef4a45?w=100&h=100&fit=crop",
  },
];
  ...
  return (
    <div className="flex gap-1">
      {Array.from({ length: 5 }).map((_, i) => (
        <svg key={i} aria-hidden="true" viewBox="0 0 20 20" fill="#D4A843" className="w-4 h-4">
